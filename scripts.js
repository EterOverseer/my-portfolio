...
const translations = {
  en: {
    ...
    'key-os': 'Preferred OS',
    'key-salary': 'Expected Salary',
    'val-salary': '13,000 – 15,000 ฿',
    'key-avail': 'Available',
  ...
  th: {
    ...
    'key-salary': 'เงินเดือนที่ต้องการ',
    'val-salary': '13,000 – 15,000 ฿',
...
const contactData = {
  github: {
    ...
    name: 'GitHub', label: 'github', color: '#333', detail: 'github.com/saharat-dev'
  },
  facebook: {
    ...
    name: 'Facebook', label: 'facebook', color: '#1877f2', detail: 'facebook.com/saharat'
  },
  line: {
